            ...
            <div className={styles.content1}>
              <div className={styles.head}>
                ...
                <div className={styles.laCirugaRefractiva}>
                  ...
                  refractivos del ojo. En condiciones normales, la imagen
                  penetra en el ojo a través de la córnea y del cristalino hasta
                  proyectarse en la retina mediante un proceso conocido como
                  refracción. Desde la retina, la imagen se transmite al cerebro
                  ...
                  <div className={styles.divptAccordionBox}>
                    ...
                    <div className={styles.divptAccordionDetails}>
                      <div className={styles.puedesAcudirA}>
                        Puedes acudir a una consulta de dermatología si ves
                        alguna anomalía en la piel, el cuero cabelludo, los
                        labios, las uñas o las membranas mucosas. En la primera
                        consulta el dermatólogo te hará un diagnóstico y te
                        indicará cual es el tratamiento más adecuado para tu
                        caso. Las patologías más frecuentes son dermatitis,
                        psoriasis, alopecia, detección de verrugas, enfermedades
                        infecciosas o un melanoma. También puedes acudir al
                        dermatólogo para tratar un problema de estética o para
                        eliminar algún tatuaje.
                      </div>
                    </div>
                  </div>
                </div>
